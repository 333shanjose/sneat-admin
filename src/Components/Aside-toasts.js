  ...
  return (
    <>
       <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
          ...
          <div class="ps__rail-x" style={{left:'0px', bottom:'-889px'}}><div class="ps__thumb-x" tabindex="0" style={{left:'0px', width:'0px'}}></div></div>
          <div class="ps__rail-y" style={{top:'889px', height:'1086px', right:'4px'}}>
            <div class="ps__thumb-y" tabindex="0" style={{top:'479px', height:'585px'}}></div></div></ul>
        </aside>
    </>
  )
}

export default Asidetoasts