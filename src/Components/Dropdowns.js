    ...
    <>
     <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">UI elements /</span> Dropdowns</h4>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                      ...
                      <div class="demo-inline-spacing">
                        <div class="btn-group" id="dropdown-icon-demo">
                          <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bx bx-menu me-1"></i> With Icon
                          </button>
                          <ul class="dropdown-menu">
                            <li>
              ...
              <div class="card" id="dropdown-variation-demo">
                ...
                <div class="card-body">
                  ...
                  <div class="demo-inline-spacing">
                    <div class="btn-group">
                      <button class="btn btn-primary btn-xl dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Extra large button
                      </button>
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="javascript:void(0);">Action</a></li>
                ...
                <div class="card-body">
                  <div class="row gy-3">
                    <div class="col-xl-6">
                      <small class="text-light fw-medium">Options : Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to change the
