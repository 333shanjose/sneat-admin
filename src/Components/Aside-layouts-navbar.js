  ...
  return (
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
          ...
          <div class="ps__rail-x" style={{left:'0px', bottom:'0px'}}>
            ...
            <div class="ps__rail-y" style={{top:'0px', height:'1086px', right:'4px'}}>
            <div class="ps__thumb-y" tabindex="0" style={{top:'0px', height:'840px'}}></div></div></ul>
        </aside>
...
export default Asidelayoutsnavbar